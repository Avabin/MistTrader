...
public partial class ProxyViewModel : ViewModel, IActivatableViewModel
{
    ...
    private SourceCache<ResponseCaptured, DateTimeOffset> _capturedResponses = new(x => x.Timestamp);
    
    public IObservableCollection<MistwoodResponseViewModel> CapturedResponses { get; }
    
    

    public ProxyViewModel(IMediator mediator, IMessageBus bus, IMessageBoxService messageBoxService)
    {
    ...
    private void OnResponseCaptured(ResponseCaptured notification)
    {
